...
def create_probability_interface(system_components):
    ...
    def explain_rf_probability_decision(sample, system_components, original_rf_model=None):
        ...
        if explanation['is_qualitative_cluster']:
            print(f"⚠️  Sample assigned to QUALITATIVE ANALYSIS cluster: {cluster_assignment}")
...
# =============================================================================
# MAIN EXECUTION PIPELINE (MODIFIED)
# =============================================================================
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Note: We'll need to pass the original data differently since we modified the structure
